...
const std::string WALLE_EE_FORCE = "cs225a::force_sensor::WALLE::end-effector::force";
const std::string WALLE_EE_MOMENT = "cs225a::force_sensor::WALLE::end-effector::moment";
